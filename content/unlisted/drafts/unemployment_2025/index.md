...
As my previous contract engagement completed on a very good note back in August of 2025. I was once again back on the job hunt. As many of you know the current job market was and still is not in a great a great spot. With countless lay-offs from major companies, rising inflation and other economic factors started brewing an unemployment storm.

Lets just say it wasn't easy during this time. It was a grind, discouraging at times and exhausting. I wanted to share my story and experience during this time and showcase some of the fun projects I got to work on during the extra time I had on my hands.

### The Grind

First I wanted to cover my job application strategy. To keep organized I created a Google Sheets file to keep track of all my applications:
...
Unfortunately I don't have many sadly. I think the current job market is partially a numbers game. As in you just have to keep applying. You also can't dwell on picking the perfect job to apply for. You gotta look at the description, company and role and if meets your skill set and interests I would apply for it.

#### Resume
Another tip is to update your resume per application. Look for keywords that you can leverage and help stand out. Does the role mention "*Security Operations*" and you passed Security Plus? mention in your resume how "Security Operations" is one of the domains for that certification. Small changes like that can really help you stand out and get passed the dreaded "***Filter***".

#### The Power of AI
They keep saying AI is going to replace all the jobs right? Well I am not sure whats going to happen on that front but what I can say is AI can be a powerful tool during the interview process. I used AI platforms such as ChatGPT to help generate me interview questions and scenarios to help me practice answering and sharing stories from past career experiences.
...
So what else did I do during my time? Sleep in so late and miss the McDonalds breakfast? Or did I try to expand my IT and Cyber skills with all this extra time? Well multiple things can be true at once.
...
I also got to work on some fun technical projects as well during my break. It was nice having the extra time to dive deep into these subjects and to really try and understand how these systems work.
...
I like to make video projects from time to time, whether it was for a school project or other events and I wanted a better way to view this files without uploading them to an externally hosted platform such as YouTube or Vimeo. That's when I remembered the Plex product.

After some research and work I was able to deploy a Plex Media Server via Docker on my NAS. This was great but relied on CPU media encoding for remote streaming. Which in most cases is fine but if I wanted to play some of video projects in higher quality without buffering. This lead me down the rabbit hole of AV1 hardware encoding with Intel ARC GPU's... But that's a story for another day. (*Another blog post perhaps?*). In the end I deployed the new hardware and I got Plex hardware transcoding working in real time.

##### Remote Machine Learning Server with Immich
After learning the the self hosted Photos app I was already running on my NAS had support for [Remote Machine Learning](https://docs.immich.app/guides/remote-machine-learning/) I knew I had to try it out. Again a longer story for another day... (*Another Another blog post perhaps?*). But After some networking troubleshooting I was able to deploy the AI Docker cluster on my Proxmox homelab server.
